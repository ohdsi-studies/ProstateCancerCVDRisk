...
OhdsiRTools::checkUsagePackage("EPI720")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EPI720.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EPI720.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EPI720")
