...
getCovariateBalance <- function(connection,
  ...
  #balance$databaseId <- factor(balance$databaseId, levels(balance$databaseId)) 
...
getKaplanMeier <- function(connection, targetId, comparatorId, databaseId, outcomeId, analysisId) {
